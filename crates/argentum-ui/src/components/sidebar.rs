...
use super::separator::SeparatorOrientation;
...
/// Sidebar separator — re-export of `separator` with sidebar semantics.
#[component]
pub async fn sidebar_separator(
    #[default] orientation: SeparatorOrientation,
    #[default] mut attrs: Attributes,
) -> Result {
    // Inline separator rendering with sidebar data attribute
    view! {
        <hr
