// SYNC: topcoat-ui-registry@0.9.0 sha256:df9073df351770ee0282b9c64b7724caa0422fb51d7823fd3615688f4d02ddf6 — do not hand-edit. Sync via `cargo xtask sync-topcoat-ui` (ADR-0007).
use topcoat::{
    Result,
    runtime::Expr,
