// SYNC: topcoat-ui-registry@0.8.0 sha256:9cf7ce740191227bde90bf6e085abacca6e90e3b16385c6ace7d455fc032709d — do not hand-edit. Sync via `cargo xtask sync-topcoat-ui` (ADR-0007).
use topcoat::{
    Result,
