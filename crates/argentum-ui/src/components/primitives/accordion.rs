// SYNC: topcoat-ui-registry@0.7.0 sha256:a59bae3aa096245f63f78c467ff12108316814bc724691751d5edcdddf40721b — do not hand-edit. Sync via `cargo xtask sync-topcoat-ui` (ADR-0007).
use topcoat::{
    Result,
