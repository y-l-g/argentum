// SYNC: topcoat-ui-registry@0.9.0 sha256:606de70a794bea536dc2c419a9e0069a82537556da0829112a52a5934cc69c12 — do not hand-edit. Sync via `cargo xtask sync-topcoat-ui` (ADR-0007).
use topcoat::{
    Result,
