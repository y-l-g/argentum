// SYNC: topcoat-ui-registry@0.6.2 sha256:237e2d1d23687302808316618a4de08cbf0cf5ffbadb49117d00df86a9166b0f — do not hand-edit. Sync via `cargo xtask sync-topcoat-ui` (ADR-0007).
use topcoat::{
    Result,
