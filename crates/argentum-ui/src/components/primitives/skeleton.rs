// SYNC: topcoat-ui-registry@0.8.1 sha256:f6faa9563198a85864ac4571cac986f46add9d62ef2d6b215dc019b53fb5390c — do not hand-edit. Sync via `cargo xtask sync-topcoat-ui` (ADR-0007).
use topcoat::{
    Result,
