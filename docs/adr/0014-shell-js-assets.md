...
shipped, and `examples/showcase/assets/media.test.js` tests the showcase's `media.js` — ~68.3 KB
unminified, ~26.2 KB gzipped summed per asset, with no build or minify step). They
